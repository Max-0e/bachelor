Im folgenden Kapitel wird die Implementierung des Konzepts als webbasierte Anwendung beschrieben und dokumentiert.
...
\begin{center}
    \begin{minipage}{0.8\linewidth}
        \includegraphics[width=\linewidth]{Swagger1}
        \captionof{figure}{API-Dokumentation Teil 1}
    \end{minipage}
\end{center}
\begin{center}
    \begin{minipage}{0.8\linewidth}
        \includegraphics[width=\linewidth]{Swagger2}
        \captionof{figure}{API-Dokumentation Teil 2}
    \end{minipage}
\end{center}
\begin{center}
    \begin{minipage}{0.8\linewidth}
        \includegraphics[width=\linewidth]{Swagger3}
        \captionof{figure}{API-Dokumentation Teil 2}
    \end{minipage}
\end{center}
\vspace{20pt}
