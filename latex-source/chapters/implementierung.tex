...
\begin{center}
    \begin{minipage}{0.8\linewidth}
        \includegraphics[width=\linewidth]{Backend-Struktur}
        \captionof{figure}{Abbildung der Backend-Struktur}
    \end{minipage}
\end{center}
\vspace{20pt}
...
Für Jira-Projekte kann das Mapping der Felder größtenteils automatisch durchgeführt werden, das bedeutet, dass Aufgaben und Epics sofort erkannt werden. Die Stati der Aufgaben können anhand der Metadaten von JIRA auch automatisch ausgelesen werden. Falls die tatsächliche Verwendung von den Meta-Daten abweichen sollte, hat der Nutzer die Möglichkeit jeden Status aus Jira dem gewünschten Status innerhalb des Prototyps zuzuordnen.
...
Die Datenbank für den Produktiv-Server ist eine kostenlose Version einer Cloud-Instanz von Mongo-Atlas.